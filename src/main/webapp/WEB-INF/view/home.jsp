  ...
  <body>
	...
	<div id="container">
		...
		<form id="randomPerson">
			<input type="submit" value="Get Random Person" /> <br /><br/>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#randomPerson').submit(function(e) {
			...
			$('#idForm').submit(function(e) {
				...
				if(!validatePersonId(personId)) 
					return false;
				$.get('${pageContext.request.contextPath}/api/person/id/' + personId, function(person) {
			...
			$('#newPersonForm').submit(function(e) {
				...
				$.post('${pageContext.request.contextPath}/api/person/id', $(this).serialize(), function(response) {
